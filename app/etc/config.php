...
return [
    'modules' => [
        ...
        'Aventi_Documents' => 1,
        'Aventi_ExcelModeView' => 1,
        'Aventi_Gshipping' => 1,
        'Aventi_Imagen' => 1,
        'Aventi_ManagerPrice' => 1,
        'Aventi_OrderComment' => 1,
        'Aventi_PickUpWithOffices' => 1,
        'Aventi_PointOfSale' => 1,
        'Aventi_PriceList' => 1,
        'Aventi_QuickOrder' => 1,
        'Aventi_SAP' => 1,
        'Aventi_ShowInventory' => 1,
        'Aventi_UpdateOrderStatus' => 1,
        'Aventi_Webscrapping' => 1,
        'Deved_DisableRegistration' => 1,
        'Doofinder_Feed' => 0,
        'Doofinder_FeedCompatibility' => 0,
        ...
        'Magefan_Community' => 1,
        'Magefan_GoogleTagManager' => 1,
        'Magenest_Core' => 1,
        'Magenest_Popup' => 1,
        'Magetop_Smtp' => 1,
        'Solicitud_CustomerTab' => 1,
