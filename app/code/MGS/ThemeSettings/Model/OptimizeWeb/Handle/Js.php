...
use MGS\ThemeSettings\Helper\HtmlHelper;
...
class Js extends AbstractRegExp
{
    ...
    public function deferParsingOfJs(&$html)
    {
		...
		*/
        ...
        foreach (array_reverse($jsElementList) as $_jsElement) {
            ...
            $html = HtmlHelper::cutHtmlString($html, $_jsElement['start'], $_jsElement['end']);
        }
        $html = HtmlHelper::insertCodeBeforeBodyEnd($resultHtml, $html);
        return $this;
    }
    ...
    public function mergeJavascriptInline(&$html)
    {
        ...
        foreach (array_reverse($jsElementList) as $_jsElement) {
            $html = HtmlHelper::replaceIntoHtml(
