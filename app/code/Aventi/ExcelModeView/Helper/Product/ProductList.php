<?php
namespace Aventi\ExcelModeView\Helper\Product;
...
class ProductList extends \Magento\Catalog\Helper\Product\ProductList
{
    ...
    public function getAvailableViewMode()
    {
        ...
        switch ($value) {
            ...
            case 'list-grid-excel':
                $availableMode = ['list' => __('List'), 'grid' => __('Grid'), 'excel' => __('Excel')];
                break;
            case 'list-excel-grid':
                $availableMode = ['list' => __('List'), 'excel' => __('Excel'), 'grid' => __('Grid')];
                break;
            case 'excel-list-grid':
                $availableMode = ['excel' => __('Excel'), 'list' => __('List'), 'grid' => __('Grid')];
                break;
            case 'excel-grid-list':
                $availableMode = ['excel' => __('Excel'), 'grid' => __('Grid'), 'list' => __('List')];
                break;
            default:
                $availableMode = null;
                break;
